...
async function convertRepositoryToEntandoBundle (bundle) {
  return Bundle(bundle.metadata, bundle.spec.details, bundle.spec.tags);
}

async function convertPackageToEntandoDeBundle (modules, options) {
...
module.exports = {
  ...
  generateModuleName,
  generateThumbnail,
  convertRepositoryToEntandoBundle,
  convertPackageToEntandoDeBundle,
};
