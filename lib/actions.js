  ...
  inquirer
    ...
    .then((answers) => {
      switch (answers.action) {
        case 'from-git':
          return gitBundler.interactiveSession().then(answers => generateFromGit(answers));
        case 'from-env':
          return envBundler.interactiveSession();
        default:
    ...
    .catch(error => {
      console.error('An error occurred while running interactive session:');
